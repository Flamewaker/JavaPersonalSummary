 ...
 * 代理一般都是和被代理对象属于同一个接口
 */
public class LiMingTiktokProxy implements com.todd.design.structural.decorator.ManTikTok {

    private com.todd.design.structural.decorator.ManTikTok manTikTok; //被代理对象
